...
public class WebTestController {
	...
	@Autowired
	protected WebTestService accountsService;

	protected Logger logger = Logger.getLogger(WebAccountsController.class
			.getName());

	public WebTestController(WebTestService accountsService) {
	...
	@RequestMapping(value = "/test/dosearch")
